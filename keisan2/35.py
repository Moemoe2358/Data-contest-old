...
weight = {0:{"ビジネス立地":0.89, "住宅立地":0.82, "観光立地":0.99, "学校立地":0.69}, 1:{"ビジネス立地":0.88, "住宅立地":0.9, "観光立地":0.87}}
# lel, ael, alel, llel = [], [], [], []
# p = 0
...
for i in range(len(test)):
	...
	if length >= 3:
		submit["b"][i] = weight[natural][location] * temp["y"][length - 1] + (1 - weight[natural][location]) * temp["y"][length - 2]
