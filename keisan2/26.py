...
for i in range(len(test)):
	...
	if length >= 3:
		submit["b"][i] = 0.6 * temp["y"][length - 1] + 0.4 * temp["y"][length - 2]
	...
	lel.append(le)
	ale = (np.log(temp['y'][length - 1] + 1) - np.log(0.6 * temp['y'][length - 2] + 0.4 * temp['y'][length - 3] + 0 * temp['y'][length - 4] + 1)) ** 2
	alel.append(ale)
...
# Len: 12
# Last 0.16
# Moving Average 0.167 0.163 0.162 0.157
# 2rd Last 0.203
# Average 0.149

# Len: 11
# Last 0.156
# Moving Average 0.139 0.14 0.141 0.139
# 2rd Last 0.159
# Average 0.144

# Len: 10
# Last 0.149
# Moving Average 0.139 0.138 0.139 0.137
# 2rd Last 0.16
# Average 0.158

# Len: 9
# Last 0.136
# Moving Average 0.124 0.124 0.119 0.119
# 2rd Last 0.147
# Average 0.129

# Len: 8
# Last 0.137
# Moving Average 0.125 0.125 0.132 0.127
# 2rd Last 0.149
# Average 0.161

# Len: 7
# Last 0.133
# Moving Average 0.141 0.136 0.152 0.142
# 2rd Last 0.186
# Average 0.164

# Len: 6
# Last 0.153
# Moving Average 0.151 0.148 0.155 0.145
# 2rd Last 0.197
# Average 0.149

# Len: 5
# Last 0.176
# Moving Average 0.179 0.175 0.166 0.163
# 2rd Last 0.215
# Average 0.166
